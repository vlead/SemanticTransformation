...
* Implementation
We will deliver the system in releases titled r0, r1, r2... Each release will be implemented, archived in GitHub repository and finally deployed on the web behind IIIT-Hyd firewall. 

On GitHub, the coding will be done in seperate cloned repository. The final code will be pulled into the VLEAD repository after adequate review. 
